...
public class SelectOrderReq implements ReqWrap {

	private String supplierOrderId;
	
	public SelectOrderReq(String supplierOrderId) {
	...
	public String getApiUrl() {
		return XmlConfig.getAttributeValue("/api_config/"+Constant.STB_CODE+"/selectOrder", "value");
	}
