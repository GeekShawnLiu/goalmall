 ...
 *
 */
public class OrderSelectChildrenApi extends AbstractBusinesApi<OrderSelectRes> {
	private static Log log = LogFactory.getLog(OrderSelectChildrenApi.class);
	public OrderSelectChildrenApi(String orderId){
	...
	protected OrderSelectRes resolver(String result) {
		...
		if(success){
			...
			if(StringUtils.isNotEmpty(pOrder) && (pOrder.equals("0")||cOrder_Node.isMissingNode())){
	...
	public static void main(String[] args) {
		...
		OrderSelectChildrenApi orderSelectApi = new OrderSelectChildrenApi(null);
