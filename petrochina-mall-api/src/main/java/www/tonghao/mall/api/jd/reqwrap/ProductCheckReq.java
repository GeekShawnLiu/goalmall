...
public class ProductCheckReq implements ReqWrap  {
	private String sku;//多个以逗号隔开
	
	public ProductCheckReq(String sku){
		this.sku=sku;
	}
	...
	public String getApiUrl() {
		return XmlConfig.getAttributeValue("/api_config/"+Constant.JD_CODE+"/getCheck", "value");
	}
