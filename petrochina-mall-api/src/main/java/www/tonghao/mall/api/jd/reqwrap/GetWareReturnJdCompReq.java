...
/**
 * 
 * Description: 查询商品逆向配送请求参数
 * 
 * @version 2019年7月8日
 * @since JDK1.8
 */
public class GetWareReturnJdCompReq implements ReqWrap{
	...
	public GetWareReturnJdCompReq(String jdOrderId, String skuId) {
	...
	public String getApiUrl() {
		return XmlConfig.getAttributeValue("/api_config/"+Constant.JD_CODE+"/getWareReturnJdComp", "value");
	}
