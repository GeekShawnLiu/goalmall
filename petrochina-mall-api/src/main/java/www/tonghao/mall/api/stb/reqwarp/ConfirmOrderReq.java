...
public class ConfirmOrderReq implements ReqWrap {

	private String supplierOrderId;
	public ConfirmOrderReq(String supplierOrderId) {
	...
	public String getApiUrl() {
		return XmlConfig.getAttributeValue("/api_config/"+Constant.STB_CODE+"/confirmOrder", "value");
	}
