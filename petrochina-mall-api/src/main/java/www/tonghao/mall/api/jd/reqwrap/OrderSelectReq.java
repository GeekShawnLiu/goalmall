...
public class OrderSelectReq implements ReqWrap {
	...
	public OrderSelectReq(String orderId){
	...
	public String getApiUrl() {
		return XmlConfig.getAttributeValue("/api_config/"+Constant.JD_CODE+"/selectJdOrder", "value");
	}
	...
	public Map<String, String> getParams() {
		...
		param.put("queryExts", "jdOrderState");
		return param;
	}
